...
export function SettingsPanel() {
  ...
  const FIELDS = [
    ...
    { k:'intelx_key',     label:'IntelX API Key', hint:'free.intelx.io · FREE tier · breach data, paste search, dark web indexed, phonebook search', ph:'your-intelx-key', url:'https://intelx.io/account', group:'OSINT' },
